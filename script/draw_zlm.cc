...
int main( int argc, char* argv[] ){
  ...
  int nBins = 50;
  string par_string(Form("l:%i m:%i e:%i s:%i a:%i g:%f;cos#theta;#phi [deg];#Phi [deg]",m_j,m_m,m_r,m_s,pAngle,pGamma));
  TH3F* fcnHist = new TH3F("zlm", par_string.c_str(), nBins, -1, +1, nBins, -3.14, 3.14, nBins, -3.14, 3.14);
